    ...
    <table border="0" cellpadding="0" cellspcaing="0" style="max-width:935px; width:100%; padding:15px; border: grey 1px solid;" align="center">
        <tr>
            <td style="background-color: #ffffff; padding: 15px;" align="center" valign="middle">
                ...
                <img src="{{ asset('images/logo-final.png') }}" /> <br></h2><span style=" margin:0;font-family:Gilroy-Regular; font-size:20px;">hello@myadvantage.africa, 09028947748</span>        
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top" align="middle">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; background-color: #ffffff;  padding-bottom: 15px; ">
                    <tr>
                        <td>
                            <tr style="display: inline-block; font-family:Gilroy-Regular; font-size:24px; max-width: 520px; width: 100%; border: grey 1px solid; margin-top: 22px; padding: 30px ;margin-right: 100px;">
